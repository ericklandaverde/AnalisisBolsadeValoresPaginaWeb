...
<html lang="es">
<head>
<title>Comparacion Acciones(America Movil,Cemex,Wal-Mart de Mexico,Grupo Mexico,Empresas ICA).</title>
<meta charset="utf-8">
...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("datacomparacion.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            subtitle: {
	                text: 'Comparacion Acciones',   // Subtitulo (Opcional)
	            },
...
<h1>Comparacion Acciones.</h1><br>
<p>(America Movil,Cemex,Wal-Mart de Mexico,Grupo Mexico,Empresas ICA).</p><br>
