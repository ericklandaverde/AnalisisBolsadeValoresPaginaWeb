...
class  MiPDF extends FPDF {
		...
		$this->Cell(80);
		//Titulo
		$this->Cell(30,10,utf8_decode('Wal - Mart de Mexico, S.A.B. de C.V. (WALMEXV.MX).'),0,0,'C');
		//Salto de Linea
		$this->Ln(20);//Fuente
		...
		$this->Ln(4);
		$this->Cell(0,10,utf8_decode('Indices precio al consumidor'),0,0,'C');
		$this->Ln();
		$this->Ln(4);
...
$consulta = mysql_query( "SELECT * FROM walmart " );
