...
<html lang="es">
<head>
<title>Analisis American Movil.</title>
<meta charset="utf-8">
...
<script src="js/functionsamericanmovil.js"></script>
...
$(function () {
    ...
    $(document).ready(function() {
        $.getJSON("dataamericanmovil.php", function(json) {
		    ...
		    chart = new Highcharts.Chart({
	            ...
	            subtitle: {
	                text: 'American Movil',   // Subtitulo (Opcional)
	            },
...
<?php
$conexion=mysqli_connect("mysql.hostinger.es","u228980204_pg","aipZwHQoh9","u228980204_bv") or die("No hay conexion");
$conectBD=mysqli_select_db($conexion,"u228980204_bv") or die("No existe base de datos");
...
<a class="btn btn-danger pull-right" target="_blank" href="reporte_americanmovil.php">Descargar Listado </a> 
<!-- Creacion de tabla........................................................................................................................... -->
<center>
<h1>America Movil.</h1><br>
<p>America Movil, S.A.B. de C.V. (AMXL.MX).</p><br>
	<table>
		<thead>
			<tr>
				<th>Fecha</th>
